...
parser.add_argument('--fitness', type=float, help='the fitness threshold', required=False, default=10.)
...
print('fp ard fitness: {} {} threshold'.format(fp_fitness.value, '>' if float(fp_fitness.value) > args.fitness else '<='))
print('pc ard fitness: {} {} threshold'.format(pc_fitness.value, '>' if float(pc_fitness.value) > args.fitness else '<='))
